    ...
    <div class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
      ...
      <body>
        ...
        if (isset($_POST['button'])) {
          ...
          if (isset($idreponse) && isset($id) && isset($vision) && $comment) {
            ...
            $query->bindValue(':vision', $vision);
            $query->bindValue(':comment', $comment);
            $query->bindValue(':notepro', $notepro);
            $query->execute();
            if ($db) { //si la requête a été effectuée avec succès , on fait une redirection
              echo "reponse ajouter avec succes";
            } else { //si non
        ...
        <div class="form">
          <a href="listavis.php" class="back_btn"><img src="images/back.png"> Retour</a>
          ...
          <form action="" method="POST">
            <label>idreponse</label>
            <input type="number" name="idreponse" pattern="[0-9]+">
            ...
            <select name="vision" id="vision">
              <option value="contre lavis">contre lavis</option>
              <option value="avec lavis">avec lavis</option>
            ...
            <label>comment</label>
            <input type="text" name="comment" pattern="[a-zA-Z ]+">

            <label>note propose</label>
            <label for="customRange3" class="form-label">donner une note sur 5</label>
            <input type="range" class="form-range" min="0" max="5" step="0.5" name="notepro">
