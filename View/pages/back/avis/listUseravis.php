...
$avisc= new avisc();
$list=$avisc->listUseravis($_SESSION['id_user']) ?>
<!DOCTYPE html>
<html lang="en" 
>
...
<td><?=$avis['id'];?></td>
    ...
    <td><?=$avis['datee'];?></td>
    <td><a href="deleteavis.php?id=<?=$avis['id']?>"><img src="../../../assets/images/trash.png"></a></td>
<td><a href="mi.php?id=<?=$avis['id']?>"><img src="../../../assets/images/pen.png"></a></td>
