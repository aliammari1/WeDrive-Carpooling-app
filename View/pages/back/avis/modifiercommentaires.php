  ...
  <div class="flex flex-wrap mt-6 -mx-3">
    ...
    <div class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
      ...
      <body>
        ...
        $req = $pdo->prepare("SELECT * FROM commentaires WHERE comment_id = ?");
        ...
        if (isset($_POST['button'])) {
          ...
          if (isset($name) && isset($message)) {
            ...
            $req = $pdo->prepare("UPDATE commentaires SET name = :name, message = :message WHERE comment_id= :comment_id");
        ...
        <div class="form">
          ...
          <h2>Modifier l'avis : <?= $row['name'] ?> </h2>
          ...
          <form action="" method="POST">
            ...
            <label>message</label>
            <input type="text" name="message" pattern="[a-zA-Z ]+" value="<?= $row['message'] ?>">
