...
if (isset($_POST['post_comment'])) {
    ...
    $sql = "INSERT INTO commentaires (name, message,note_up,note_down, post_id) VALUES (:name, :message,:note_up,:note_down, :post)";

    $stmt = $pdo->prepare($sql);
    $stmt->execute(['name' => $name, 'message' => $message,'note_up' => $note_up,'note_down' => $note_down, 'post' => $post]);
...
<body>
    ...
    <h2>Ajouter un commentaire</h2>
        <form action="" method="post" class="form">
            ...
            <br>
           <!-- <input type="text" class="note_up" name="note_up" placeholder="note_up">
            <input type="text" class="note_down" name="note_down" placeholder="note_down"> -->
            <label for="customRange2" class="form-label">Like</label>
<input type="range" class="form-range" min="0" max="1" name="note_up" >
<br>
<label for="customRange2" class="form-label">Dislike</label>
<input type="range" class="form-range" min="0" max="1" name="note_down" >
<br>
...
const note_upInput = document.querySelector('.note_up');
const note_downInput = document.querySelector('.note_down');
...
form.addEventListener('submit', (event) => {
  ...
  if (messageInput.value.trim() === '') {
    ...
    <div class="content">
        ...
        <td> <h3><?php echo $comment['name']; ?></h3></td>
        <td><p id="message"><?php echo $comment['message']; ?></p></td>
