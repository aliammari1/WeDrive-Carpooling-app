        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0">
            <li class="breadcrumb-item text-sm ps-2">
              <a class="opacity-5 text-white" href="javascript:">لوحات القيادة</a>
            </li>
          ...
          <div class="card">
            <div class="card-body p-3">
              ...
              <p class="text-sm ms-2">
                (<span class="font-weight-bolder">+23%</span>) من الأسبوع
                الماضي
              </p>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> 10 TND </span>
                      </td>
                      <td class="align-middle">
                        <div class="progress-wrapper w-75 mx-auto">
                          <div class="progress-info">
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        ...
        <div class="d-flex">
          <button class="btn bg-gradient-primary w-100 px-3 mb-2 active ms-2" data-class="bg-white" onclick="sidebarType(this)">
            White
          </button>
