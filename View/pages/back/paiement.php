                  ...
                  <tr>
                    <td class="w-30">
                      ...
                      <button class="btn btn-primary ms-4"
                        onclick="deletePaiement(this,<?= $paimentsArray['id_p'] ?>)">delete</button>
                      <button class="btn btn-primary ms-2" data-bs-toggle="modal"
                        data-bs-target="#exampleModal<?= $paimentsArray['id_p'] ?>">update</button>
                    </td>
                  </tr>
                  <div class="modal fade" id="exampleModal<?= $paimentsArray['id_p'] ?>" tabindex="-1" role="dialog"
