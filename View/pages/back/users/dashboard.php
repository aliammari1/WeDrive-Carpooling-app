        ...
        <div class="container-fluid py-4">
            <div class="row mt-4">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent">
                            <h6 class="text-capitalize">Statistiques des utilisateurs</h6>
                        </div>
                ...
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent">
                            <h6 class="text-capitalize">Statistiques des types de reclamations</h6>
                        </div>
                        <div class="card-body p-3">
                            <div class="chart">
    ...
    <script>
        ...
        fetch("../../../Controller/Users/ControlChart.php")
            ...
            .then(data => {
                ...
                gradientStroke2.addColorStop(0.2, "rgba(94, 114, 228, 0.1)");
