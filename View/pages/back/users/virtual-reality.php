...
<body class="g-sidenav-show bg-gray-100 virtual-reality">
  ...
  <div class="border-radius-xl mt-4 mx-4 position-relative" style="
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
      ...
      <div class="navdash">
        <img <?php echo 'src="data:image/jpeg;base64,' . base64_encode($user->getProfileImage()) . '"' ?> alt="profileImage" style="max-height: 400px !important; display: block !important" class="w-60 rounded-circle shadow-sm navbar-brand-img" onclick="changeImage()" id="profile-image" />
        <p><?= $user->getPrenom(); ?></p>
      </div>
      ...
      <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav dashnav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="virtual-reality.php">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="row pt-10">
            <div class="col-lg-1 col-md-1 pt-5 pt-lg-0 ms-lg-5 text-center">
              <a href="javascript:" class="avatar avatar-md border-0 d-block mb-2" data-bs-toggle="tooltip" data-bs-placement="left" title="My Profile">
                <img class="border-radius-lg" alt="Image placeholder" <?php echo 'src="data:image/jpeg;base64,' . base64_encode($user->getProfileImage()) . '"' ?> />
              </a>
