...
#require_once($_SERVER['DOCUMENT_ROOT'] . 'Controller/crudtraject/trajectsC.php');
...
<div class="card z-index-2 h-90">
        ...
        <center><h2 class="card-title">ajouter un traject </h2></center>
           <div class="row">
				<div class="col-md-6">
