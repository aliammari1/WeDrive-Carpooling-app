...
include_once "../../../../Model/crudtraject/adresss.php";
...
<div class="card z-index-2 h-90">
        ...
        <center><h2 class="card-title">ajouter un adress </h2></center>
...
<script src="../../../../scriptjs/modifyInput.js"></script> 
 ...
 <script>
  ...
  function calculateDistance(point1, point2) {
    ...
    if (  distance < 20 ){ type.value= "short trip " }else{ type.value="long trip" }
    return distance;
  }
