  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav dashnav">
        <li class="nav-item">
          <a class="nav-link active" href="statistiquesRec.php">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Statistiques</h6>
        </nav>
      ...
      <div class="row mt-4">
        <div class="col-lg-7 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div style="text-align: center;" class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Statistiques Des Noms Des Reclamations</h6>
            </div>
          ...
          <div class="card">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Noms Des Reclamations</h6>
              </div>
            </div>
        ...
        new Chart(ctx1, {
          ...
          data: {
            ...
            datasets: [{
              ...
              pointRadius: 0,
              borderColor: "#F8B195",
              backgroundColor: "#fff" /*gradientStroke1*/ ,
              borderWidth: 1,
              fill: true,
