...
<html lang="en">
  <head>
    ...
    <link
      ...
      integrity="sha384-G8Nv55OhLaLxjkfzDOw27ikW8+wrGEGnm9XkysaJ0t0+NR8jPcJxPveo31CHfztG"
      crossorigin="anonymous"
    />
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/flaticon@11.0.1/css/flaticon.css"
      integrity="sha384-31IkX41D6+3qgJqxYtr1kbyxHmGQzOm/+6lJU6fZU9XuSY7cL/HSdGn4V4Jz5u5K"
      crossorigin="anonymous"
    />
...
<div class="container">
 <a href="addavis.php" class="Btn_add"> <img src="../../assets/images/plus.png"> Ajouter</a>
...
<tr>
    ...
    <td><?=$avis['datee'];?></td>
    <td><a href="commnet.php?id=<?= $avis['id']?>" class="btn">Comment</a></td>
</tr>
<?php } ?>
        </div>
    </form>
