        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img <?php echo 'src="data:image/jpeg;base64,' . base64_encode($user->getProfileImage()) . '"' ?> alt="profileImage" class="w-100 border-radius-lg shadow-sm" />
            </div>
          </div>
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1"><?php echo $user->getPrenom(); ?></h5>
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                ...
                <button class="btn btn-primary btn-sm ms-2 bg-danger" onclick="deleteAccount(<?= $user->getID() ?>)">
                  Delete account
                </button>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="<?= $user->getPrenom() ?>" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Last name</label>
                    <input class="form-control" type="text" value="<?= $user->getNom() ?>" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="email" value="<?= $user->getEmail(); ?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="<?= $user->getAdresse() ?>" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Numero de Telephone</label>
                    <input class="form-control" type="text" value="<?= $user->getNumTel() ?>" />
                  </div>
                </div>
              </div>
              <hr class="horizontal dark" />
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="Happy Riding with WeDrive" disabled />
                  </div>
                </div>
              </div>
            </div>
    ...
    function deleteAccount(id) {
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch('../../../Controller/Users/ControlProfile.php?id_user=' + id)
