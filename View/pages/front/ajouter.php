    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a href="front/services.html" class="nav-link">Services</a>
          </li>
          <li class="nav-item">
            <a href="front/pricing.html" class="nav-link">Pricing</a>
          </li>
          <li class="nav-item">
            <a href="front/car.html" class="nav-link">Cars</a>
          </li>
          <li class="nav-item">
            <a href="front/blog.html" class="nav-link">Blog</a>
          </li>
          <li class="nav-item active">
            <a href="front/contact.html" class="nav-link">avis</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              <div class="border w-100 p-4 rounded mb-2 d-flex">
                ...
                <p>
                  <a href="http://localhost/gestionavis/front/View/pages/front/star/" class="nav-link">afficher les avis sur notre we drive</a>
                </p>
              </div>
            </div>
            <div class="col-md-12">
              <div class="border w-100 p-4 rounded mb-2 d-flex">
                ...
                <p>
                  <span>Phone:</span>
                  <a href="http://localhost/gestionavis/front/View/pages/front/list.php"> repondre a une avis</a>
                </p>
              </div>
            </div>
            <div class="col-md-12">
        ...
        <div class="col-md-8 block-9 mb-md-5">
          ...
          <body>
            ...
            if (isset($_POST['button'])) {
              ...
              if (isset($id) && isset($typee) && isset($note) && $commentaire) {
                ...
                $query->execute();
                if (true) { //si la requête a été effectuée avec succès , on fait une redirection
                  $message = "avis ajouter!";
                  echo $message;
                } else {
                  //si non
            ...
            <div class="form">
              ...
              <h2>remplir la formulaire de l'avis</h2>
              ...
              <form action="" method="POST" class="d-flex flex-column">
                <label>id</label>
                <input type="number" name="id" pattern="[0-9]+" title="L'ID doit contenir uniquement des lettres majuscules et des chiffres">>
                ...
                <input type="submit" value="Ajouter" name="button" class="mt-4">
